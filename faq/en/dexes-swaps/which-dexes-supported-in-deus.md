# Which DEXes are supported in Deus?

Deus wallet currently supports the following decentralized exchanges:
...
In the future, Deus aims to complete integration with the [Thorchain](https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains.
